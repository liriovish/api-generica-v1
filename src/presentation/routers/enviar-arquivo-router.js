...
/**
 * Classe EnviarArquivoRouter
 * @package  src\presentation\routers
 */
module.exports = class EnviarArquivoRouter {
    /**
     * Construtor
     ...
     */
     async route(oBody, sIp, sToken, oParams, sTokenJwt, oQuery, oFiles) {
        try {
            /**
             ...
             * @var {object} oArquivo
             *
             * @UsaFuncao enviarArquivo
             */
            const oArquivo = await this.whatsappUseCase.enviarArquivo(oFiles, oCliente)
